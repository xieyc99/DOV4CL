...
import methods.DINO.vision_transformer as vits
from methods.DINO.vision_transformer import DINOHead
from loaders.diffaugment import set_aug_diff
...
def get_args_parser():
    ...
    parser.add_argument('--method', default='dino', type=str,
                        help='Name of SSL method to train')
    parser.add_argument('--arch4log', default='vitS_dino', type=str,
                        choices=['vitT', 'vitS', 'vitS_2', 'vitB', 'vitL', 'vitH'])
    parser.add_argument('--arch', default='vit_small', type=str,
        # choices=['vit_tiny', 'vit_small_patch4', 'vit_small', 'vit_base', 'xcit', 'deit_tiny', 'deit_small'] \
    ...
    # Misc
    parser.add_argument('--dataset', default='imagenette', choices=['cifar10', 'cifar100', 'svhn', 'tiny-imagenet', 'stl10', 'imagewoof', 'imagenette'
                                                                   'imagenet-bird', 'imagenet-reptile-reptilian'])
    parser.add_argument('--part', default='', choices=['before', 'after'])
    parser.add_argument('--unlabel', default=True)
    parser.add_argument('--data_path', default='D:\exp\datasets', type=str,
                        help='dataset path')
    parser.add_argument('--log_path', default='Experiments', type=str, 
                        help='path to save log')
    parser.add_argument('--log_dir', default=".", type=str, help='Path to save logs and checkpoints.')
    ...
    parser.add_argument('--gpu', default=0, type=int,
                help='GPU id to use.')
    parser.add_argument('--trial', default='clean', type=str)
...
def train_dino(args):
    ...
    args.log_dir = os.path.join(
            "./{}/imagenette/{}-{}-{}-{}-{}-{}".format(args.log_path, args.dataset, args.part, args.method, args.arch4log, args.trial, args.unlabel)) if args.part != '' else os.path.join(
                "./{}/imagenette/{}-{}-{}-{}-{}".format(args.log_path, args.dataset, args.method, args.arch4log, args.trial, args.unlabel))
    ...
    utils.restart_from_checkpoint(
        os.path.join(args.output_dir, "checkpoint0800.pth"),
